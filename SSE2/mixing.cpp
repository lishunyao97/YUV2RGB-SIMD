...
void RGBMixing(int t){
    ...
    __m128 alpha_ = _mm_set_ps((float)(256-t)/256, (float)(256-t)/256, (float)(256-t)/256,(float)(256-t)/256);
    for(int i=0;i<height;i++){
...
//            tmpRGB[2][i][j]=(double)(t*RGB1[2][i][j]+(256-t)*RGB2[2][i][j])/256;
            __m128 RGB1_0 = _mm_set_ps((float)RGB1[0][i][j+3], (float)RGB1[0][i][j+2], (float)RGB1[0][i][j+1], (float)RGB1[0][i][j]);
            __m128 RGB1_1 = _mm_set_ps((float)RGB1[1][i][j+3], (float)RGB1[1][i][j+2], (float)RGB1[1][i][j+1], (float)RGB1[1][i][j]);
            __m128 RGB1_2 = _mm_set_ps((float)RGB1[2][i][j+3], (float)RGB1[2][i][j+2], (float)RGB1[2][i][j+1], (float)RGB1[2][i][j]);
            __m128 RGB2_0 = _mm_set_ps((float)RGB2[0][i][j+3], (float)RGB2[0][i][j+2], (float)RGB2[0][i][j+1], (float)RGB2[0][i][j]);
            __m128 RGB2_1 = _mm_set_ps((float)RGB2[1][i][j+3], (float)RGB2[1][i][j+2], (float)RGB2[1][i][j+1], (float)RGB2[1][i][j]);
            __m128 RGB2_2 = _mm_set_ps((float)RGB2[2][i][j+3], (float)RGB2[2][i][j+2], (float)RGB2[2][i][j+1], (float)RGB2[2][i][j]);
            
            __m128 tmpRGB1_0 = _mm_mul_ps(RGB1_0, alpha);
            __m128 tmpRGB1_1 = _mm_mul_ps(RGB1_1, alpha);
            __m128 tmpRGB1_2 = _mm_mul_ps(RGB1_2, alpha);
            __m128 tmpRGB2_0 = _mm_mul_ps(RGB2_0, alpha_);
            __m128 tmpRGB2_1 = _mm_mul_ps(RGB2_1, alpha_);
            __m128 tmpRGB2_2 = _mm_mul_ps(RGB2_2, alpha_);
            
            __m128 tmpRGB_0 = _mm_add_ps(tmpRGB1_0, tmpRGB2_0);
            __m128 tmpRGB_1 = _mm_add_ps(tmpRGB1_1, tmpRGB2_1);
            __m128 tmpRGB_2 = _mm_add_ps(tmpRGB1_2, tmpRGB2_2);
...
//            B=1.164383*(YUV1[0][i][j]-16)+2.017232*(YUV1[1][i][j]-128);
            __m128 YUV_0 = _mm_set_ps((float)YUV1[0][i][j+3],(float)YUV1[0][i][j+2],(float)YUV1[0][i][j+1],(float)YUV1[0][i][j]);
            __m128 YUV_1 = _mm_set_ps((float)YUV1[1][i][j+3],(float)YUV1[1][i][j+2],(float)YUV1[1][i][j+1],(float)YUV1[1][i][j]);
            __m128 YUV_2 = _mm_set_ps((float)YUV1[2][i][j+3],(float)YUV1[2][i][j+2],(float)YUV1[2][i][j+1],(float)YUV1[2][i][j]);
...
//            B=1.164383*(YUV2[0][i][j]-16)+2.017232*(YUV2[1][i][j]-128);
            ...
            YUV_0 = _mm_set_ps((float)YUV2[0][i][j+3],(float)YUV2[0][i][j+2],(float)YUV2[0][i][j+1],(float)YUV2[0][i][j]);
            YUV_1 = _mm_set_ps((float)YUV2[1][i][j+3],(float)YUV2[1][i][j+2],(float)YUV2[1][i][j+1],(float)YUV2[1][i][j]);
            YUV_2 = _mm_set_ps((float)YUV2[2][i][j+3],(float)YUV2[2][i][j+2],(float)YUV2[2][i][j+1],(float)YUV2[2][i][j]);
            YUV_0 = _mm_sub_ps(YUV_0,sub_0);
            YUV_1 = _mm_sub_ps(YUV_1,sub_1);
            YUV_2 = _mm_sub_ps(YUV_2,sub_1);
            RGB_Y = _mm_mul_ps(YUV_0,coe_0);
            G_U=_mm_mul_ps(YUV_1,coe_1_G);
            B_U=_mm_mul_ps(YUV_1,coe_1_B);
            R_V=_mm_mul_ps(YUV_2,coe_2_R);
            G_V=_mm_mul_ps(YUV_2,coe_2_G);
            rtR = _mm_add_ps(RGB_Y,R_V);
            rtG = _mm_add_ps(RGB_Y,G_U);
            rtG = _mm_add_ps(rtG,G_V);
            rtB = _mm_add_ps(RGB_Y,B_U);
