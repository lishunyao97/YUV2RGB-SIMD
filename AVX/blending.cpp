...
void RGBBlending(int t){
    ...
    for(int i=0;i<height;i++){
        for(int j=0;j<width;j+=8){
            ...
            __m256 RGB_0 = _mm256_set_ps((float)RGB[0][i][j+7], (float)RGB[0][i][j+6], (float)RGB[0][i][j+5], (float)RGB[0][i][j+4], (float)RGB[0][i][j+3], (float)RGB[0][i][j+2], (float)RGB[0][i][j+1], (float)RGB[0][i][j]);
            __m256 RGB_1 = _mm256_set_ps((float)RGB[1][i][j+7],(float)RGB[1][i][j+6],(float)RGB[1][i][j+5],(float)RGB[1][i][j+4],(float)RGB[1][i][j+3], (float)RGB[1][i][j+2], (float)RGB[1][i][j+1], (float)RGB[1][i][j]);
            __m256 RGB_2 = _mm256_set_ps((float)RGB[2][i][j+7],(float)RGB[2][i][j+6],(float)RGB[2][i][j+5],(float)RGB[2][i][j+4],(float)RGB[2][i][j+3], (float)RGB[2][i][j+2], (float)RGB[2][i][j+1], (float)RGB[2][i][j]);
            __m256 tmpRGB_0 = _mm256_mul_ps(RGB_0, alpha);
            __m256 tmpRGB_1 = _mm256_mul_ps(RGB_1, alpha);
            __m256 tmpRGB_2 = _mm256_mul_ps(RGB_2, alpha);
...
void YUV2RGB(){
    ...
    for(int i=0;i<height;i++){
        for(int j=0;j<width;j+=8){
            ...
            __m256 YUV_0 = _mm256_set_ps((float)YUV[0][i][j+7],(float)YUV[0][i][j+6],(float)YUV[0][i][j+5],(float)YUV[0][i][j+4],(float)YUV[0][i][j+3],(float)YUV[0][i][j+2],(float)YUV[0][i][j+1],(float)YUV[0][i][j]);
            __m256 YUV_1 = _mm256_set_ps((float)YUV[1][i][j+7],(float)YUV[1][i][j+6],(float)YUV[1][i][j+5],(float)YUV[1][i][j+4],(float)YUV[1][i][j+3],(float)YUV[1][i][j+2],(float)YUV[1][i][j+1],(float)YUV[1][i][j]);
            __m256 YUV_2 = _mm256_set_ps((float)YUV[2][i][j+7],(float)YUV[2][i][j+6],(float)YUV[2][i][j+5],(float)YUV[2][i][j+4],(float)YUV[2][i][j+3],(float)YUV[2][i][j+2],(float)YUV[2][i][j+1],(float)YUV[2][i][j]);
